...
eda_nodes <- create_node_df(n=6, 
               type=c("action", "action",
                      "action", "action",
                      "action", "action"),
               label = c("what variables are in the data, and how was it collected?",
                         "lots of open-ended questions", 
                         "lots of plots and numerical summaries and even models",
                         "what do you see", 
                         "are these patterns likely to occur by chance",
                         "summarise findings"),
               shape = c("rectangle", "rectangle",
                         "rectangle", "rectangle",
                         "rectangle", "rectangle"),
